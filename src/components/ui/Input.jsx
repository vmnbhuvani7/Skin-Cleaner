      ...
      <div className="relative group">
        {Icon && (
          <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            <Icon size={18} className="text-[var(--text-muted)] group-focus-within:text-primary-400 transition-colors" />
          </div>
        )}
        <input
          ref={ref}
          className={twMerge(
            clsx(
              ...
              "focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500/50 transition-all text-sm shadow-sm",
              Icon && "pl-12",
