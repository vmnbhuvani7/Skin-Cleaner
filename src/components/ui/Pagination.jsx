        ...
        <button
          ...
          className={twMerge(
            ...
            currentPage === i 
              ...
              : "border-[var(--border)] text-[var(--text-muted)] hover:border-primary-400 hover:text-primary-400 bg-[var(--surface)]"
          )}
        >
          {i}
        </button>
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="w-10 h-10 rounded-xl border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] disabled:opacity-30 disabled:cursor-not-allowed hover:border-primary-400 hover:text-primary-400 transition-all bg-[var(--surface)]"
        >
          <ChevronLeft size={18} />
        </button>
