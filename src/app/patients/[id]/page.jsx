        ...
        <div className="max-w-4xl mx-auto pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[2.5rem] p-8 relative overflow-hidden shadow-xl">
              <div className="absolute top-0 right-0 w-32 h-32 bg-primary-600/5 blur-[40px] rounded-full pointer-events-none"></div>
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-3xl bg-primary-500/10 flex items-center justify-center text-primary-400 mb-6 border border-primary-500/20 shadow-inner overflow-hidden">
                  {patient.image ? (
                ...
                <p className="text-primary-400 font-bold uppercase tracking-[0.2em] text-[10px] mb-4">{patient.gender} • {patient.age} Years</p>
                <div className="flex gap-2">
                  <span className={`px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider border ${patient.isActive ? 'bg-success-500/10 text-success-500 border-success-500/20' : 'bg-danger-500/10 text-danger-500 border-danger-500/20'}`}>
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[2.5rem] p-8 shadow-sm">
              <h3 className="text-sm font-bold text-[var(--foreground)] uppercase tracking-widest mb-6 flex items-center gap-2">
                <ClipboardList size={16} className="text-primary-400" /> Medical Summary
              </h3>
