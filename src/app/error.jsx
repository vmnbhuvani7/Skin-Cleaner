  ...
  return (
    <div className="min-h-screen w-full bg-[#0a0a0c] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-danger-900/10 blur-[150px] rounded-full" />
      ...
      <div className="relative z-10 max-w-xl w-full">
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[3rem] p-10 md:p-12 shadow-2xl backdrop-blur-xl space-y-10">
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            <div className="w-24 h-24 rounded-[2rem] bg-danger-500/10 border border-danger-500/20 flex items-center justify-center text-danger-500 shadow-inner">
          ...
          <div className="bg-black/40 rounded-2xl p-5 border border-white/5 space-y-3">
            ...
            <p className="text-[11px] font-mono text-danger-400/80 break-all leading-relaxed bg-danger-500/5 p-3 rounded-lg border border-danger-500/10">
        ...
        <div className="mt-8 text-center">
          <p className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.2em]">
            Need assistance? <span className="text-primary-400 hover:text-primary-300 cursor-pointer transition-colors">Contact System Admin</span>
          </p>
        </div>
      </div>
    </div>
