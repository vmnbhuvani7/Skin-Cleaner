          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[2.5rem] p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[var(--foreground)] tracking-tight">Add New Service</h1>
                  <p className="text-[var(--text-muted)] text-xs font-medium">Define a new treatment or service for your clinic.</p>
                </div>
              </div>
