                ...
                >
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={() => router.push(`/services/edit/${service.id}`)} className="p-2 bg-white/5 hover:bg-white/10 rounded-xl text-gray-400 hover:text-white transition-all">
                        <Edit size={16} />
                      </button>
                      <button onClick={() => handleDeleteClick(service.id)} className="p-2 bg-white/5 hover:bg-rose-500/10 rounded-xl text-gray-400 hover:text-rose-400 transition-all">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
