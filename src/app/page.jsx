...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[var(--background)] min-h-screen selection:bg-primary-100 dark:selection:bg-primary-500/30 selection:text-primary-900 dark:selection:text-primary-200 transition-colors duration-300">
      <LandingHeader />
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute -top-[10%] -right-[5%] w-[60%] h-[80%] bg-primary-500/5 dark:bg-primary-400/5 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute -bottom-[10%] -left-[5%] w-[40%] h-[60%] bg-primary-600/5 dark:bg-primary-500/5 rounded-full blur-[100px]"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-50/80 dark:bg-primary-500/10 border border-primary-100 dark:border-primary-500/20 text-primary-700 dark:text-primary-400 text-[10px] font-bold uppercase tracking-[0.2em] mb-8 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <Button variant="ghost" className="px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-transparent gap-3">
                <span className="w-10 h-10 rounded-full border border-primary-500/20 flex items-center justify-center group-hover:bg-primary-500/10 transition-colors">
                  <ArrowRight size={18} />
                </span>
                View Treatments
              </Button>
          ...
          >
            <div className="relative z-10 rounded-[3.5rem] overflow-hidden border-[12px] border-white dark:border-[#0f172a] shadow-[0_40px_100px_-20px_rgba(13,148,136,0.3)] aspect-[4/5] max-w-[480px] ml-auto">
              ...
              <div className="absolute bottom-8 left-8 right-8 glass p-6 rounded-3xl shadow-2xl border-white/20">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-2xl bg-primary-500 flex items-center justify-center text-white shadow-lg shadow-primary-500/40">
                    <Zap size={24} fill="currentColor" />
                  </div>
                  <div>
                    <h4 className="font-bold text-white text-lg">Scalp Analysis</h4>
                    <p className="text-primary-50 text-xs font-medium">AI-Powered Detection</p>
                  </div>
                </div>
            ...
            <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-primary-600/10 rounded-full blur-3xl"></div>
          </motion.div>
        </div>
      </section>
            ...
            {services.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group bg-white dark:bg-[#0f172a] p-10 rounded-[3rem] border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-2xl hover:shadow-primary-500/10 dark:hover:shadow-primary-500/5 transition-all relative overflow-hidden"
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-primary-500/5 rounded-bl-full translate-x-8 -translate-y-8 group-hover:scale-150 transition-transform duration-500"></div>
                  
                  <div className="w-16 h-16 rounded-2xl bg-primary-50 dark:bg-primary-500/10 flex items-center justify-center text-primary-600 dark:text-primary-400 mb-8 group-hover:scale-110 transition-transform duration-500">
                  ...
                  <Button variant="ghost" size="sm" className="px-0 text-primary-600 dark:text-primary-400 hover:bg-transparent uppercase tracking-widest">
          ...
          <div className="glass-card rounded-[4rem] overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 md:p-20 flex flex-col justify-center">
                <div className="w-16 h-16 rounded-2xl bg-primary-500 flex items-center justify-center text-white mb-8 shadow-xl shadow-primary-500/30">
                  <Sparkles size={32} />
                </div>
                ...
                <div className="space-y-6 mb-12">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4">
                      <div className="w-6 h-6 rounded-full bg-primary-50 dark:bg-primary-500/10 flex items-center justify-center text-primary-600 dark:text-primary-400">
              ...
              <div className="relative h-[400px] lg:h-auto min-h-[500px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="glass p-8 rounded-3xl max-w-sm w-full mx-6 shadow-2xl animate-bounce-slow">
                    <p className="text-primary-600 dark:text-primary-400 font-bold uppercase tracking-widest text-[10px] mb-4">Diagnosis Preview</p>
                    <h4 className="text-white font-bold text-xl mb-6">Density Analysis</h4>
                    <div className="space-y-4">
                      <div className="h-2 w-full bg-white/20 rounded-full overflow-hidden">
                        <div className="h-full bg-primary-400 w-[70%]"></div>
                      </div>
                      <div className="h-2 w-full bg-white/20 rounded-full overflow-hidden">
                        <div className="h-full bg-success-400 w-[45%]"></div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-32 bg-primary-950 dark:bg-[#020617] text-white overflow-hidden relative">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,_var(--tw-gradient-stops))] from-primary-500 via-transparent to-transparent"></div>
        </div>
        
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Your Personalized Roadmap</h2>
            <p className="text-primary-100/60 text-lg">Every scalp is unique. Your treatment plan should be too. Here's how we build your transformation journey.</p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="bg-white/5 border border-white/10 p-8 rounded-[2.5rem] backdrop-blur-sm">
                  <div className="text-3xl font-bold text-primary-400 mb-4">{item.step}</div>
                  <h4 className="text-xl font-bold mb-2">{item.title}</h4>
                  <p className="text-primary-100/40 text-sm leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
              ...
              <div className="absolute -bottom-10 -right-10 glass p-10 rounded-[3rem] shadow-2xl max-w-[320px] hidden md:block">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-primary-400/60 text-[10px] font-bold uppercase tracking-widest">Active Phase</p>
                  </div>
                </div>
                <p className="text-sm text-primary-100/60 leading-relaxed italic">"The personalized serum formulated after my diagnosis showed results in just 4 weeks."</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="why-us" className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="w-full aspect-square rounded-[3rem] bg-primary-50 dark:bg-primary-500/5 overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-primary-600/10 dark:bg-primary-900/40"></div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-white dark:bg-[#0f1117] p-8 rounded-[2rem] shadow-2xl border border-gray-100 dark:border-white/5 max-w-[280px] hidden md:block">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-full bg-success-50 dark:bg-success-500/10 flex items-center justify-center text-success-600 dark:text-success-400">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={item} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary-50 dark:bg-primary-500/10 flex items-center justify-center text-primary-600 dark:text-primary-400 shrink-0">
                      <CheckCircle2 size={14} />
                    </div>
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-32 bg-primary-50/30 dark:bg-[#060a14] relative">
        <div className="max-w-7xl mx-auto px-6">
              ...
              >
                <div className="flex gap-1 mb-8">
                  {[...Array(t.rating)].map((_, idx) => (
                    <Star key={idx} size={16} className="fill-primary-500 text-primary-500" />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-4 border-t border-gray-50 dark:border-white/5 pt-8">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-2 -right-2 w-6 h-6 rounded-full bg-primary-500 border-2 border-white dark:border-[#0f172a] flex items-center justify-center text-white">
                      <CheckCircle2 size={12} />
                    </div>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">{t.name}</h4>
                    <p className="text-xs text-primary-600 dark:text-primary-400 font-bold uppercase tracking-widest">{t.role}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section id="faq" className="py-32">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {faqs.map((faq, idx) => (
              <details key={idx} className="bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-white/5 rounded-[2rem] p-8 cursor-pointer group open:ring-2 open:ring-primary-500/20 transition-all overflow-hidden">
                <summary className="font-bold text-xl text-gray-900 dark:text-white flex items-center justify-between list-none">
                  {faq.q}
                  <div className="w-8 h-8 rounded-full bg-primary-50 dark:bg-primary-500/10 flex items-center justify-center text-primary-600 dark:text-primary-400 group-open:rotate-180 transition-transform">
                    <ChevronDown size={18} />
                  </div>
                </summary>
      ...
      <section id="appointment" className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="bg-primary-900 dark:bg-[#0a0c10] rounded-[5rem] p-8 md:p-24 shadow-2xl overflow-hidden relative border border-white/5">
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary-400/10 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/3"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
              <div>
                ...
                <p className="text-primary-100/60 text-xl mb-12 leading-relaxed">
                  Join 10,000+ satisfied patients who started their journey with a single consultation. Our slots fill up fast.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-2">
                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-primary-400 mb-2">
                      <Phone size={24} />
                    </div>
              ...
              <form className="space-y-6 bg-white dark:bg-[#0f172a] p-10 md:p-14 rounded-[3.5rem] shadow-2xl">
                ...
                <Button className="w-full py-6 text-lg mt-6 shadow-2xl shadow-primary-600/20">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-3 mb-10">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-primary-600 font-bold uppercase tracking-[0.2em] leading-none">Aesthetic Clinic</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                {[Facebook, Instagram, Twitter, Linkedin].map((Icon, i) => (
                  <button key={i} className="w-12 h-12 rounded-2xl bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-white/5 flex items-center justify-center text-gray-400 hover:bg-primary-600 hover:text-white transition-all duration-300">
                    <Icon size={20} />
                  </button>
                ))}
              </div>
            ...
            <div>
              ...
              <ul className="space-y-5">
                {["Hair Diagnosis", "Follicle Mapping", "Custom Serums", "Laser Therapy", "Growth Factors"].map(item => (
                  <li key={item}>
                    <a href="#" className="text-gray-500 dark:text-gray-400 text-sm hover:text-primary-600 transition-colors font-medium">{item}</a>
                  </li>
                ))}
              </ul>
            </div>
