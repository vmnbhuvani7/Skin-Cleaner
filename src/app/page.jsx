    ...
    <div className="bg-white min-h-screen selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-gray-900 leading-[1.1] tracking-tight mb-8">
              Reveal Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Best Skin</span> & Hair
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <button className="flex items-center gap-2 text-gray-600 font-bold hover:text-indigo-600 transition-colors px-6">
        ...
        {/* Floating Decor */}
        <div className="hidden lg:block absolute bottom-20 right-20 w-[400px] h-[500px] rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-bounce-slow">
      ...
      <section id="services" className="py-24 bg-stone-50/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Our Specialized Services</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="w-full aspect-square rounded-[3rem] bg-indigo-50 overflow-hidden relative">
                <img src="/dermatology_clinic_hero_1777282738062.png" alt="Why Choose Us" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-indigo-600/10"></div>
              </div>
              <div className="absolute -bottom-10 -right-10 bg-white p-8 rounded-[2rem] shadow-2xl border border-gray-100 max-w-[280px] hidden md:block">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600">
                    <CheckCircle2 size={24} />
                  </div>
                  <span className="font-bold text-gray-900">100% Safe & Hygienic</span>
                </div>
                <p className="text-xs text-gray-500 leading-relaxed">Our clinic maintains international standards of hygiene and patient safety.</p>
              </div>
            </div>

            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8 leading-tight">Expert Care for Your <br />Beauty & Wellness</h2>
      ...
      <section id="testimonials" className="py-24 bg-indigo-50/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Real Results, Real Reviews</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">Hear from our clients who have transformed their skin and hair with our professional treatments.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
                ...
                <p className="text-gray-700 font-medium mb-8 leading-relaxed italic">"{t.text}"</p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-stone-100"></div>
                  <div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500">Your journey to beautiful skin in four simple steps.</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 relative">
            {/* Connector Line */}
            <div className="hidden lg:block absolute top-10 left-40 right-40 h-0.5 bg-dashed-border -z-0"></div>
            ...
            {[
              ...
              <div key={idx} className="relative z-10 text-center">
                <div className="w-20 h-20 rounded-[2rem] bg-white border-2 border-indigo-50 flex items-center justify-center text-indigo-600 font-bold text-2xl mx-auto mb-8 shadow-lg">
                  {step.step}
                </div>
      ...
      <section id="faq" className="py-24 bg-stone-50/50">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <details key={idx} className="bg-white border border-gray-100 rounded-[1.5rem] p-6 cursor-pointer group open:ring-2 open:ring-indigo-500/20 transition-all">
                ...
                <div className="mt-4 text-gray-500 text-sm leading-relaxed animate-in fade-in slide-in-from-top-2 duration-300">
                  {faq.a}
                </div>
              </details>
            ))}
      ...
      <section id="appointment" className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="bg-white rounded-[4rem] p-8 md:p-20 shadow-2xl overflow-hidden relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">Get Your Free Skin <br />Consultation Today</h2>
                <p className="text-gray-600 mb-10 leading-relaxed">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-bold text-gray-700">hello@skincleaner.com</span>
                  </div>
                </div>
              </div>

              <form className="space-y-6 bg-stone-50/50 p-8 md:p-12 rounded-[3rem] border border-gray-100">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            <div>
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="font-bold text-xl text-gray-900 tracking-tight">Skin Cleaner</span>
              </div>
              ...
              <div className="flex gap-4">
                {[Facebook, Instagram, Twitter, Linkedin].map((Icon, i) => (
                  <button key={i} className="w-10 h-10 rounded-xl bg-stone-50 border border-gray-100 flex items-center justify-center text-gray-500 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 transition-all">
                    <Icon size={18} />
                  </button>
                ))}
              </div>
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-8 uppercase text-xs tracking-widest">Our Services</h4>
              <ul className="space-y-4">
                {["Laser Hair Removal", "Acne Treatment", "Hair Restoration", "Chemical Peels", "Dermal Fillers", "Facial Care"].map(item => (
                  <li key={item}>
                    <a href="#" className="text-gray-500 text-sm hover:text-indigo-600 transition-colors">{item}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-8 uppercase text-xs tracking-widest">Quick Links</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-8 uppercase text-xs tracking-widest">Location</h4>
              <div className="space-y-6">
                ...
                <div className="bg-stone-50 p-6 rounded-[2rem] border border-gray-100">
                  <p className="text-xs font-bold text-gray-900 uppercase mb-3 tracking-widest">Business Hours</p>
                  <p className="text-[10px] text-gray-500 mb-1 font-bold flex justify-between">MON - FRI <span>09:00 - 20:00</span></p>
                  <p className="text-[10px] text-gray-500 font-bold flex justify-between">SAT - SUN <span>10:00 - 18:00</span></p>
                </div>
              </div>
            </div>
          </div>
