...
export default function NotFound() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0a0a0c] flex items-center justify-center p-6">
      ...
      {/* Decorative Blurs */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-primary-600/20 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-2xl w-full text-center space-y-8 animate-in fade-in zoom-in duration-700">
        <div className="space-y-4">
          ...
          <div className="-mt-24 space-y-2">
            <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight">
              Lost in the <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 via-purple-400 to-pink-400">Void</span>
            </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link href="/">
            <Button 
              size="lg" 
              className="px-8 h-14 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white shadow-xl shadow-primary-600/20 group"
              icon={Home}
            >
              Back to Safety
            </Button>
          ...
          <Button
            ...
            className="text-gray-400 hover:text-white hover:bg-transparent uppercase tracking-widest px-6 h-14"
          >
        ...
        <div className="absolute -top-10 -right-10 w-20 h-20 bg-gradient-to-br from-primary-500/20 to-transparent rounded-full blur-xl animate-pulse" />
