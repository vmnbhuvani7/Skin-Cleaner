...
export default function SignupPage() {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#0f1117] border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-2xl dark:shadow-primary-500/5 relative overflow-hidden">
        {/* Mobile Branding */}
        <div className="lg:hidden flex flex-col items-center mb-10">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-success-600 flex items-center justify-center shadow-xl mb-4">
        ...
        {error && (
          <motion.div
            ...
            className="mb-8 p-4 bg-danger-50 dark:bg-danger-500/10 border border-danger-100 dark:border-danger-500/20 rounded-2xl text-danger-600 dark:text-danger-400 text-xs font-bold uppercase tracking-wider text-center"
          >
            {error}
          </motion.div>
        )}
        ...
        <div className="flex gap-4 mb-8">
          <div
            ...
            className={`flex-1 cursor-pointer p-4 rounded-2xl border-2 transition-all ${formData.roleName === 'Patient'
                ...
                : 'border-gray-100 dark:border-white/5 hover:border-primary-200 dark:hover:border-primary-500/30'
              }`}
          >
            <div className="flex items-center gap-3">
              <div className={`p-2 rounded-xl ${formData.roleName === 'Patient' ? 'bg-primary-500 text-white' : 'bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400'}`}>
                <User size={20} />
              </div>
              <div>
                <h3 className={`font-bold ${formData.roleName === 'Patient' ? 'text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300'}`}>Patient</h3>
          ...
          >
            <div className="flex items-center gap-3">
              <div className={`p-2 rounded-xl ${formData.roleName === 'Organization' ? 'bg-primary-500 text-white' : 'bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400'}`}>
                <Zap size={20} />
              </div>
              <div>
                <h3 className={`font-bold ${formData.roleName === 'Organization' ? 'text-primary-700 dark:text-primary-300' : 'text-gray-700 dark:text-gray-300'}`}>Organization</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {formData.roleName === 'Patient' && orgData?.publicGetOrganizations?.length > 0 && (
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="h-14 rounded-2xl border border-[var(--border)] bg-[var(--surface)] text-sm font-medium focus:ring-primary-500 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 bottom-3.5 text-gray-400 hover:text-primary-500 transition-colors"
              >
          ...
          >
            ...
            <p className="text-[13px] text-gray-500 dark:text-gray-400 leading-relaxed group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors">
              I agree to the <Link href="#" className="text-primary-500 dark:text-primary-400 font-bold hover:underline underline-offset-4">Terms of Service</Link> and <Link href="#" className="text-primary-500 dark:text-primary-400 font-bold hover:underline underline-offset-4">Privacy Policy</Link>.
            </p>
          </div>
          ...
          <Button
            ...
            className="w-full h-14 rounded-2xl text-base font-bold shadow-xl shadow-primary-500/20 hover:shadow-primary-500/40 disabled:opacity-50 disabled:shadow-none transition-all duration-300 mt-4"
            isLoading={loading}
            icon={ArrowRight}
          >
            Create Account
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
            ...
            <Link href="/login" className="text-primary-500 dark:text-primary-400 font-bold hover:underline underline-offset-8 transition-all">
              Sign In
            </Link>
          </p>
        </div>
